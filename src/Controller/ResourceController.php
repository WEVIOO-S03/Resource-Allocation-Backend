...
class ResourceController extends AbstractController
{
        #[Route('/resources', name: 'api_resources_index', methods: ['GET'])]
            public function index(
                ...
                $resources = $resourceRepository->findAllWithOccupationRates($date);
    ...
    public function getOccupationRecords(
        ...
        try {
            ...
            error_log("Fetching occupation records for: startDate = $startDate, endDate = $endDate, projectId = $projectId");
            ...
            if ($resourceId) {
                $qb->andWhere('o.resource = :resourceId')
        ...
        try {
            ...
            try {
                ...
                if ($totalOccupation > 100) {
                    $warning = "Warning: Total occupation rate for this resource on this date exceeds 100% ({$totalOccupation}%)";
                }
